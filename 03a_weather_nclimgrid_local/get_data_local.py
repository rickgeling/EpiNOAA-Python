...
import polars as pl
# from polars.exceptions import ColumnNotFoundError # Not explicitly used
...
#immediatly instead of silently producing e.g. a "corn" output built from soy data.
...
def main():
    ...
    if missing_year_folders:
        ...
        print( "***          Every weather aggregate for those years will be NaN.")
